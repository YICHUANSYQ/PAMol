...
# Custom dependencies
from .vectorizers import SmilesVectorizer, HashedMorganVectorizer
...
class DDC:
    ...
    def __load(self, model_name):
        ...
        with tempfile.TemporaryDirectory() as dirpath:
            ...
            '''model_path = dirpath + "/mol_to_latent_model.h5"
    ...
    def fit(
        ...
        if clipvalue > 0:
            ...
            opt = adam_v2.Adam(lr=self.lr, clipvalue=self.clipvalue)

        else:
            opt = adam_v2.Adam(lr=self.lr)
