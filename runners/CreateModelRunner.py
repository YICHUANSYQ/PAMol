...
class CreateModelRunner:
    ...
    def CreateDiscriminator(self):
        ...
        discriminator_path = os.path.join(self.output_model_folder, 'discriminator.pth')
    ...
    def CreateGenerator(self):
        ...
        if not os.path.exists(self.output_model_folder):
            os.makedirs(self.output_model_folder)
        generator_path = os.path.join(self.output_model_folder, 'generator.pth')
    ...
    def c_CreateDiscriminator(self):
        ...
        if not os.path.exists(self.output_model_folder):
            os.makedirs(self.output_model_folder)
        discriminator_path = os.path.join(self.output_model_folder, 'c_discriminator.pth')
        D.save(discriminator_path)
